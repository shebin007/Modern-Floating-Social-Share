 ...
 * 
 * MODERNFLOA->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Modern_Floating_Social_Share_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		MODERNFLOA
 * @subpackage	Classes/Modern_Floating_Social_Share_Settings
 * @author		Shebin KP
 * @since		1.0.0
 */
class Modern_Floating_Social_Share_Settings{
	...
	/**
	 * Our Modern_Floating_Social_Share_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = MODERNFLOA_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'MODERNFLOA/settings/get_plugin_name', $this->plugin_name );
	}
}
