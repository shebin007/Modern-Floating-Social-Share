...
class Modern_Floating_Social_Share_Run{
	 ...
	 */
	 ...
	 function Socialshare_floating_button(){
		...
		if($wa_number != '#' && $wa_number != null):

		$shareicon = '<a href="https://web.whatsapp.com/send?text='.esc_attr($wa_msg).'&phone=+'.esc_attr($wa_number).'" class="floating-btn share" target="_blank">
	...
	function my_plugin_options() {
		...
		<h1><?= esc_html('Modern Floating Social Share Settings') ?></h1>

		<form method="POST">
			<label for="social_share_link"><?=  esc_html('FLoating Social Share whatsapp Number Format : Phone Number including Country code without "+" and spaces'); ?><br />
